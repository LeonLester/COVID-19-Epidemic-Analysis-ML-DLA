...
confirmed_US_df = pd.read_csv(
    'https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series'
    '/time_series_covid19_confirmed_US.csv')
deaths_US_df = pd.read_csv(
    'https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series'
    '/time_series_covid19_deaths_US.csv')

apple_mobility_df = pd.read_csv(
    'https://raw.githubusercontent.com/ActiveConclusion/COVID19_mobility/master/apple_reports/apple_mobility_report.csv')

# yesterday = date.today() - timedelta(days=1) most_recent_url =
# 'https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_daily_reports/'
# + yesterday.strftime('%m-%d-%Y') + '.csv' most_recent_global_df = pd.read_csv(latest_url) print(
# latest_global_df.head())
